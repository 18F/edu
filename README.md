...
To clone this repo and serve the site locally:

```shell
$ git clone git@github.com:18F/edu.git
$ cd edu
$ ./go init
$ ./go serve
```
...
`http://localhost:4000/edu/`. (Make sure to include the trailing slash! The built-in
